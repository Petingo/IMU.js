...
// Extend the global DeviceOrientationEvent interface
declare global {
...
export class DeviceOrientationControls extends EventDispatcher<{ change: {} }> {
	...
	constructor( object: Object3D ) {
		...
		const onDeviceOrientationChangeEvent = function ( event: DeviceOrientationEvent ): void {
		...
		const onScreenOrientationChangeEvent = function (): void {
		...
		const setObjectQuaternion = function ( quaternion: Quaternion, alpha: number, beta: number, gamma: number, orient: number ): void {
